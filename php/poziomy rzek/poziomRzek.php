...
<body>
    ...
    <main>
        <section id="lewo">
            ...
            <table>
                ...
                if (!isset($_POST['pokaz'])){
                    $query = "SELECT nazwa, rzeka, stanOstrzegawczy, stanAlarmowy, pomiary.stanWody FROM `wodowskazy` JOIN pomiary on wodowskazy.id = pomiary.wodowskazy_id WHERE pomiary.dataPomiaru = '2022-05-05'; ";
        ...
        <section id="prawo">
            ...
            <?php
            $query2 = "SELECT dataPomiaru, AVG(stanWody) FROM pomiary GROUP BY dataPomiaru;";
