...
<body>
    ...
    <main>
        ...
        <section id="s">
            ...
            $query1 = "SELECT plik,tytul,polubienia, autorzy.imie,autorzy.nazwisko FROM zdjecia LEFT JOIN autorzy ON zdjecia.autorzy_id = autorzy.id ORDER BY autorzy.nazwisko; ";
